 ...
 <nav class="navbar  navbar-expand-lg pb-2 d-block d-lg-none " style="background-color: #1a0f3a">
    <div class="container">
        <a class="navbar-brand" href="#">

            <img src="{{ asset('storage/sitelogo/logo_dark.webp') }}" alt="" style="width:11rem;margin-left:-2rem;">
        </a>
        ...
        <div class="collapse navbar-collapse px-3" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto border-bottom pb-1 pt-1 mb-2 mb-lg-0 gap-2 offset-lg-1">
                <li class="nav-item">
                    <a class="nav-link active text-capitalize" aria-current="page" href="#chat_experience">Al
                        Chat
                        Experience</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-capitalize" href="#live_streaming">Live Streaming</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link text-capitalize" href="#featured_videos">Featured Videos </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-capitalize" href="#stream_control">Stream Control</a>
                </li>
