...
.section-four .box-header {
    ...
    <section class="section-one navbar-header-bg-image "
        style="background-image: url('{{ asset('storage/landingpage/nav-bg-imagen.png') }}');">
        <!-- Navbar start -->
...
<g>
    ...
    <section class="hero">
    <div class="container mt-5 mg-container">
        <div class="card border-0 text-white bg-transparent">
            <div class="card-body border-0">
                <h1>{{ __('home.privacy_policy') }}</h1>

                <h2 class="mt-4">{{ __('home.introduction') }}</h2>
                <p class="mb-4">{{ __('home.introduction_text') }}</p>

                <h2 class="mt-4">{{ __('home.information_we_collect') }}</h2>

                    <p>2.1 <strong>{{ __('home.personal_data_provided') }}</strong></p>
                      <ul class="mb-4">
                <li>{!! __('home.account_information') !!}</li>
                <li>{!! __('home.user_generated_content') !!}</li>
                <li>{!! __('home.payment_information') !!}</li>
            </ul>
                    <p>2.2 <strong>{{ __('home.automatically_collected_data') }}</strong></p>
                      <ul class="mb-4">
                <li>{!! __('home.usage_data') !!}</li>
                <li>{!! __('home.device_and_connection_information') !!}</li>
                <li>{!! __('home.cookies_and_tracking2') !!}</li>
            </ul>

                <h2 class="mt-4">{{ __('home.how_we_use_information') }}</h2>
                   <p class="mb-1">3.1 <strong>{{ __('home.provide_and_improve_platform') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.provide_and_improve') }}</li>
                          </ul>
                        <p class="mb-1">3.2 <strong>{{ __('home.communtication_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.communication') }}</li>
                          </ul>  
                          
                         <p class="mb-1">3.3 <strong>{{ __('home.marketing_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.marketing') }}</li>
                          </ul>     
                          
                            <p class="mb-1">3.4 <strong>{{ __('home.legal_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{{ __('home.legal_and_compliance') }}</li>
                          </ul>  
              

                <h2 class="mt-4">{{ __('home.sharing_your_information') }}</h2>
                         <p class="mb-1">4.1 <strong>{{ __('home.service_provider_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.service_providers') }}</li>
                          </ul>
                        <p class="mb-1">4.2 <strong>{{ __('home.legal_requirement_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.legal_requirements') }}</li>
                          </ul>  
                          
                          
                            <p class="mb-1">4.3 <strong>{{ __('home.business_transfers_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{{ __('home.service_providers') }}</li>
                          </ul>  
                <!--<ul class="mb-4">-->
                <!--    <li>{{ __('home.service_providers') }}</li>-->
                <!--    <li>{{ __('home.legal_requirements') }}</li>-->
                <!--    <li>{{ __('home.business_transfers') }}</li>-->
                <!--</ul>-->

                <h2 class="mt-4">{{ __('home.data_security') }}</h2>
                    <p class="mb-1">5.1 <strong>{{ __('home.protection_measures_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.protection_measures') }}</li>
                          </ul>
                        <p class="mb-1">5.2 <strong>{{ __('home.user_responsibilities_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{{ __('home.user_responsibilities') }}</li>
                          </ul>  
                <!--<ul class="mb-4">-->
                <!--    <li>{{ __('home.protection_measures') }}</li>-->
                <!--    <li>{{ __('home.user_responsibilities') }}</li>-->
                ...
                <h2 class="mt-4">{{ __('home.data_retention') }}</h2>
                
                 <p class="mb-1">6.1 <strong>{{ __('home.retention_period_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.retention_period') }}</li>
                          </ul>
                        <p class="mb-1">6.2 <strong>{{ __('home.deletion_of_data_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{!! __('home.deletion_of_data') !!}</li>
                          </ul>  
                <!--<ul class="mb-4">-->
                <!--    <li>{{ __('home.retention_period') }}</li>-->
                <!--    <li>{{ __('home.deletion_of_data') }}</li>-->
                ...
                <h2 class="mt-4">{{ __('home.your_rights') }}</h2>
                
                
                   <p class="mb-1">7.1 <strong>{{ __('home.access_and_correction_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.access_and_correction') }}</li>
                          </ul>
                        <p class="mb-1">7.2 <strong>{{ __('home.data_portability_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.data_portability') }}</li>
                          </ul>  
                          
                         <p class="mb-1">7.3 <strong>{{ __('home.withdrawal_of_consent_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.withdrawal_of_consent') }}</li>
                          </ul>     
                          
                            <p class="mb-1">7.4 <strong>{{ __('home.right_to_object_heading') }}</strong></p>
                      <ul class="mb-2">
                          <li>{{ __('home.right_to_object') }}</li>
                          </ul> 
                          <p class="mb-1">7.5 <strong>{{ __('home.complaints_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{{ __('home.complaints') }}</li>
                          </ul> 
                <!--<ul class="mb-4">-->
                <!--    <li>{{ __('home.access_and_correction') }}</li>-->
                <!--    <li>{{ __('home.data_portability') }}</li>-->
                ...
                <h2 class="mt-4">{{ __('home.international_data_transfers') }}</h2>
                 <p class="mb-1">8.1 <strong>{{ __('home.transfer_mechanisms_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{{ __('home.transfer_mechanisms') }}</li>
                          </ul> 
                <!--<ul class="mb-4">-->
                <!--    <li>{{ __('home.transfer_mechanisms') }}</li>-->
                <!--</ul>-->

                <h2 class="mt-4">{{ __('home.cookies_and_tracking') }}</h2>
                
                    <p class="mb-1">9.1 <strong>{{ __('home.cookies_privacy_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{{ __('home.cookies_privacy') }}</li>
                          </ul> 
                          
                              <p class="mb-1">9.2 <strong>{{ __('home.third_party_analytics_heading') }}</strong></p>
                      <ul class="mb-4">
                          <li>{{ __('home.third_party_analytics') }}</li>
                          </ul> 
                <!--<ul class="mb-4">-->
                <!--    <li>{{ __('home.cookies_privacy') }}</li>-->
                <!--    <li>{{ __('home.third_party_analytics') }}</li>-->
                ...
                <h2 class="mt-4">{{ __('home.changes_to_privacy_policy') }}</h2>
                <p class="mb-4">{{ __('home.changes_to_privacy_policy_text') }}</p>

                <h2 class="mt-4">{{ __('home.contact_us_privacy') }}</h2>
                <p class="mb-4">{!! __('home.contact_us_text') !!}</p>
            </div>
        </div>
    </div>
</section>
